		...
		<!-- <div id="preloader">
			<div id="loader" class="loader">
				<div class="loader-container">
					<div class="loader-icon"><img src="<?php //echo get_template_directory_uri() ?>/assets/img/logo/bg-logo.png" alt="ScaleLabz - Creative Agency">
					</div>
				</div>
			</div>
		</div> -->
							...
							<div class="menu-wrap">
								<nav class="menu-nav">
									...
									<div class="header-action">
										<ul class="list-wrap">
											<li class="header-btn"><a href="#contact-us" class="btn">Contact
													<span></span></a></li>
										</ul>
									</div>
								</nav>
							...
							<div class="col-lg-4">
								<div class="customer-support-wrap">
									...
									<div class="customer-support-content">
										...
										<p>We offer solutions for businesses of all sizes. For questions about our plans
											and products,,
